...
{
    public class SystemManagementRepository : RepositoryBase<SystemManagement>, ISystemManagementRepository
    {
        public SystemManagementRepository(ApplicationDbContext context) : base(context) { }
    }
}
